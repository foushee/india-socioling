...
noeng_summary_tab$langmod_labels <- NA
noeng_summary_tab[
  noeng_summary_tab$langmod=="Gujarati [AUDIO]",]$langmod_labels <-  "Gujarati (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Gujarati [NAME]",]$langmod_labels <-  '"Gujarati" (name)'
noeng_summary_tab[
  noeng_summary_tab$langmod=="Hindi [AUDIO]",]$langmod_labels <-  "Hindi (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Hindi [NAME]",]$langmod_labels <-  '"Hindi" (name)'
noeng_summary_tab[
  noeng_summary_tab$langmod=="Mandarin [AUDIO]",]$langmod_labels <-  "Mandarin (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Mandarin [NAME]",]$langmod_labels <-  '"Chinese" (name)'
noeng_summary_tab[
  noeng_summary_tab$langmod=="Marathi [AUDIO]",]$langmod_labels <-  "Marathi (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Marathi [NAME]",]$langmod_labels <-  '"Marathi" (name)'
noeng_summary_tab[
  noeng_summary_tab$langmod=="Tamil [AUDIO]",]$langmod_labels <-  "Tamil (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Tamil [NAME]",]$langmod_labels <-  '"Tamil" (name)'
noeng_summary_tab[
  noeng_summary_tab$langmod=="Urdu [AUDIO]",]$langmod_labels <-  "Urdu (audio)"
noeng_summary_tab[
  noeng_summary_tab$langmod=="Urdu [NAME]",]$langmod_labels <-  '"Urdu" (name)'

noeng_summary_tab$langmod_labels <- factor(noeng_summary_tab$langmod_labels, 
                                    levels= c("Gujarati (audio)",
                                      '"Gujarati" (name)',
                                      "Hindi (audio)",
                                      '"Hindi" (name)',
                                      "Urdu (audio)",
...
ggplot(noeng_summary_tab, aes(x=langmod_labels, y=mean, 
                      fill=langmod_labels, color=langmod_labels)) +
  geom_bar(stat="identity", position=position_dodge(width=0.9)) +
  geom_errorbar(aes(ymin=ci.lo, ymax=ci.hi, color=langmod_labels), width=0) + 
  ylab("Mean Proportion") + 
  sans_theme +
  theme(axis.title.y = element_text(size=11, colour=line_color, 
...
ggsave("plots/barplots_overall/englishes_barplot.pdf", device="pdf", width=7, height=4, scale=1.25, units="in")
```
